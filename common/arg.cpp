...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        ...
        "reduces quantization error by encoding deltas between tokens",
        [](common_params & params) {
    ...
    add_opt(common_arg(
        {"--delta-kv-interval"}, "N",
        string_format("keyframe interval for delta KV compression (default: %d)", params.delta_kv_interval),
        [](common_params & params, int value) {
